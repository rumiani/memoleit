...
export default function CategoryItem({ item }: { item: ItemTypes }) {
  return (
    <div className="bg-blue-50 word-box h-fit overflow-y-auto border border-gray-300 rounded-lg p-2 flex flex-col justify-between w-full min-w-72 max-w-80 mx-auto my-4">
